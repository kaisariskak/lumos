class IbadatReport {
  ...
  int getCustomValue(String categoryId) => customValues[categoryId] ?? 0;

  void setCustomValue(String categoryId, int value) {
    customValues[categoryId] = value;
  }
  ...
  IbadatReport copyWith() {
    return IbadatReport(
      ...
      updatedAt: updatedAt,
      customValues: Map<String, int>.from(customValues),
    );
  }
}
