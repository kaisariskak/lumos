...
Future<void> main() async {
  ...
  await Supabase.initialize(
    ...
    anonKey:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN5ZHNreGl2ZGppY2t3d3lqZXFiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzE0OTI3NzcsImV4cCI6MjA4NzA2ODc3N30.RwXnyKxRHGsf2wbRP9elCSeZtqFjW7MY7Lx91z4kQkw',
  );

  runApp(const IbadatApp());

  unawaited(_warmUpGoogleSignIn());
  unawaited(_handleAuthDeepLinks());
}
...
Future<void> _handleAuthDeepLinks() async {
  try {
    ...
    debugPrint('Auth deep link setup failed: $e');
  }
}
